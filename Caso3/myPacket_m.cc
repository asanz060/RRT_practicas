...
void myPacket::setSeq(unsigned int seq)
{
    this->seq = seq;
}

unsigned int myPacket::getSource() const
{
    return this->source;
}

void myPacket::setSource(unsigned int source)
{
    this->source = source;
}

unsigned short myPacket::getType() const
{
    return this->type;
}
